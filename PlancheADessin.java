    ...
    implements MouseListener, MouseMotionListener
{
    ...
    protected double getPenRadius() { return penRadius; }
     void setPenRadius() {
	...
	for (Dessinable d : objsD) this.voad.add(d);
	this.draw();
    }
     ...
     * @return double
     */
    public double getLargeur() { return this.width; }
     ...
     * @return double
     */
    public double getHauteur() { return this.height; }
